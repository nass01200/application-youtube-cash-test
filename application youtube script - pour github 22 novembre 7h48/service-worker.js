const CACHE_NAME='dopeur-cache-v1'
const ASSETS=['/','/index.html','/login.html','/signup.html','/forgot.html','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png','/screenshots/screen1.png','/screenshots/screen2.png','/screenshots/desktop.svg']
